...
echo "  • Apex Classes (including invocable actions)"
echo "  • Agentforce Actions (GenAI Functions)"
echo "  • Agentforce Topics (GenAI Plugins)"
echo "  • Agentforce Planner (GenAI Planner Bundle)"
echo "  • Flows (including flow actions)"
echo "  • Live Chat Agent Configurations"
echo "  • Bot Configurations (if applicable)"
echo ""
echo "Note: Einstein Agent Configurations are not available via Metadata API"
echo "      and may be stored in Custom Objects or Custom Metadata"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "Key locations:"
    echo "  • Agents: $OUTPUT_DIR/main/default/einsteinAgentConfigs/"
    echo "  • External Services: $OUTPUT_DIR/main/default/externalServices/"
